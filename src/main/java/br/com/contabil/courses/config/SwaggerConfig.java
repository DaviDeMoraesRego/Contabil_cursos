package br.com.contabil.courses.config;
...
@OpenAPIDefinition(info = @Info(title = "Tabela de cursos do jogo.", 
description = "Selecionar tabela de cursos do jogo.",
contact = @Contact(name = "Davi de Moraes",
url = "http://contabil.com.br/", email = "contabil@gmail.com"),
license = @License(name = "MIT Licence")),
servers = @Server(url = "http://localhost:10090"))
